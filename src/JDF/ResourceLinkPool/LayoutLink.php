...
/**
 * This file contains the RWC\Caldera\JDF\LayoutLink class.
 *
...
/**
 * Links to a Layout resource.
 *
 * @package RWC\Caldera\JDF
 */
class LayoutLink extends AbstractLink
{
    /**
     * Creates a new LayoutLink.
     *
     * @param string $usage Usage of the LayoutLink (input or output).
     * @param string $rRef Reference to the ID of the LayoutLink.
     */
    public function __construct(string $usage, string $rRef)
    {
        parent::__construct('LayoutLink', $usage, $rRef);
    }

    /**
     * Returns a DOMElement for the LayoutLink.
     *
     * @param \DOMDocument $dom The DOMDocument used to generate the Element.
     *
     * @return \DOMElement Returns the generated LayoutLink Element.
     */
    public function getJDF(\DOMDocument $dom) : \DOMElement
    {
        $element = $dom->createElement('LayoutLink');
    ...
    public static function fromJDFElement(\DOMElement $element): \RWC\Caldera\IJDFComponent
    {
        ...
        return new LayoutLink($usage, $rRef);
    }
}
